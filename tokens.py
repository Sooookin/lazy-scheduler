...
COLOR = {
    ...
    "card":    "#efeae3",
    "dark":    "#c9c1b4",      # 눌린 그림자
    "light":   "#fffdf9",      # 올라온 면의 빛
    "pale":    "#e1dbd1",
    "wash-hi": "#f5f2eb",      # 바탕 그라데이션 밝은 쪽
    "wash-lo": "#e9e4dc",      # 어두운 쪽
...
# ---------------- 글자 굵기 ----------------
# Paperlogy 는 300 · 500 · 700 세 종. Light 는 작은 한글에서 획이 끊겨
# 읽히지 않으므로 큰 글자에만 남긴다.
WEIGHT = {
    "thin": 300,      # 17px 이상에만 (시계 · 창 제목 · 달력 연월)
    "sec":  500,      # 보조 · 라벨
    "pri":  700,      # 본문 · 제목 · 숫자
}
